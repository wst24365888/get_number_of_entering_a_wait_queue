...
cd ~/linux-5.14.9
mkdir get_number_of_entering_a_wait_queue
cd get_number_of_entering_a_wait_queue
cp $dir/get_number_of_entering_a_wait_queue.c ./get_number_of_entering_a_wait_queue.c
echo 'obj-y := get_number_of_entering_a_wait_queue.o' >> Makefile

# edit config
cd ~/linux-5.14.9
## add get_number_of_entering_a_wait_queue/ to core-y
vim Makefile
## add  451 common  get_number_of_entering_a_wait_queue    sys_get_number_of_entering_a_wait_queue
vim ~/linux-5.14.9/arch/x86/entry/syscalls/syscall_64.tbl
## append asmlinkage long sys_get_number_of_entering_a_wait_queue(pid_t pid, unsigned int * number_of_entering_a_wait_queue);
