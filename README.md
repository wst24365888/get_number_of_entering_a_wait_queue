...
### 在copy_thread裡加上清0的結果 並繼承ttwu遞增的運算

![ ](https://i.imgur.com/wtT5NWr.png)
...
Success history
:::
[copt_thread in v5.14.9](https://elixir.free-electrons.com/linux/v5.14.9/source/arch/x86/kernel/process.c#L119)

#### 第二次實驗記錄

![ ](https://i.imgur.com/mC6n50i.png)

- 把2000多次持續遞增的原因清掉，原本以為是要在狀態圖中的fork清除task_struct的狀態，但是搞錯了方向，要在copy_thread的時候才把task_struct()清0，這樣才可以準確印出實際enter queue的次數
